...
// 修改项1：在iframe弹出层关闭时，修改了iframe的关闭，避免字体库的使用
...
//容器
  Class.pt.vessel = function(conType, callback){
    ...
    var titleClass=config.headerHide?"layui-layer-title hidden ":"layui-layer-title "
    var btnClass=config.headerHide?"layui-layer-setwin hidden ":"layui-layer-setwin ";
    ...
    var titleHTML = (config.title ? '<div class="'+titleClass+'" style="'+ (titype ? config.title[1] : '') +'">'
...
//自适应
  Class.pt.auto = function(index){
    ...
    function setHeight(elem){
      ...
      //是否存在头部标题
      titHeight=config.headerHide?0:titHeight;
