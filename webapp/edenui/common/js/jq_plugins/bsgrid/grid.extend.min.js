...
(function($) {
    ...
    $.fn.bsgrid.extendInitGrid.initColumnMove = function(gridId, options) {
        ...
        var headFixedObj=$.fn.bsgrid.getGridHeaderFixd(options);
        var headFixedLen=headFixedObj.length;
        ...
        headFixedObj.each(function(i) {
            ...
            $(obj).css("-moz-user-select", "none");
            $(obj).mousedown(function() {
                bindDownData(obj, i, headFixedLen)
            });
            $(obj).mousemove(function(e) {
                e = e || event;
                var left = $(obj).offset().left;
                ...
                if (i != headFixedLen - 1 && e.clientX - nLeft > -10) {
                    mObj = nObj
                }
                if ((i != 0 && e.clientX - left < 10) || (i != headFixedLen - 1 && e.clientX - nLeft > -10)) {
                    $(obj).css({
                        cursor: "e-resize"
                    });
                    if ($.trim($(obj).data("ex_mousedown")) != "mousedown") {
                    ...
                    if (parseInt(newMWidth) > 19 && parseInt(preNewMWidth) > 19) {
                        ...
                        var preObj=$("#" + options.gridId + " thead tr:last").find("th").eq(i);
                        console.log(i);
                        // console.log("11");
                        $(mObj).width(newMWidth).prev().width(preNewMWidth);
                        console.log($(mObj));
                        // console.log(preObj.width());
                        preObj.width(newMWidth).prev().width(preNewMWidth);
                    ...
                    releaseDownData(obj, i, headFixedLen)
                }
            ...
            function bindDownData(obj, i, headFixedLen) {
                if (i != 0) {
                    $(obj).prev().data("ex_mousedown", "mousedown")
                }
                $(obj).data("ex_mousedown", "mousedown");
            ...
            function releaseDownData(obj, i, headFixedLen) {
                if (i != 0) {
                    $(obj).prev().data("ex_mousedown", "")
                }
                $(obj).data("ex_mousedown", "");
            ...
            if (options.columnsModel[hi].check == "true") {
                ...
                checkboxObjs.change(function() {
                    ...
                    if (!checked && allCheckboxObjs.filter(":checked").length == allCheckboxObjs.length) {
                        ...
                        //选择悬浮头部
                        checkboxObj.closest(".js-fixed-father").find(".table-fixed-header").find(".bsgrid_editgrid_check").prop("checked",true);
                        ...
                        //选择悬浮头部
                        checkboxObj.closest(".js-fixed-father").find(".table-fixed-header").find(".bsgrid_editgrid_check").prop("checked",false);
    ...
    $.fn.bsgrid.extendOtherMethods.fixedHeader = function(iFirst, options) {
        ...
        if (fixedGridHeight < $("#" + options.gridId).height()) {
            ...
            $("#" + options.gridId + "_fixedDiv").height("92%");
        ...
        var tableHeader="<table class='table-fixed-header bsgrid-header' id='"+options.gridId+"_fixedHeader'><thead></thead></table>";

        var $id="#"+options.gridId+"_fixedHeader";
        if($($id).length<1){

            $("#" + options.gridId + "_fixedDiv").prepend(tableHeader);
            $("#" + options.gridId + " thead tr:lt(" + headTrNum + ")").clone(true).prependTo("#" + options.gridId + "_fixedHeader thead");
    ...
    $.fn.bsgrid.extendOtherMethods.initFixedHeader = function(gridId, options) {
        $("#" + gridId).wrap('<div class="js-fixed-father" id="' + gridId + '_fixedDiv"></div>');
